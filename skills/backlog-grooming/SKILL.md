...
Spawn the `project-state-reader` subagent. It reads the story index, epics, domain contexts,
relationships, and building blocks, and returns a compact project state snapshot.
